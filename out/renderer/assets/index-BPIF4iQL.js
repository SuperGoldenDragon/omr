...
function GenIcon$1(data) {
  return (props) => /* @__PURE__ */ React.createElement(IconBase$1, _extends$4({
    ...
    if (reactExports.isValidElement(child)) {
      if (child.props.children) {
        return reactExports.cloneElement(child, {
          ...
          positionInGroup: determinePosition(index2, reactExports.Children.count(children))
        });
      } else {
        return reactExports.cloneElement(child, {
          outline,
...
const useThemeMode = () => {
  const [mode, setMode] = reactExports.useState(getInitialMode(getThemeMode()));
  reactExports.useEffect(() => {
    setModeInLS(mode);
    setModeInDOM(mode);
  }, []);
...
const getFormattedDate = (language2, date, options) => {
  let defaultOptions2 = {
    day: "numeric",
    month: "long",
    year: "numeric"
  ...
  return new Intl.DateTimeFormat(language2, defaultOptions2).format(date);
};
...
const DatepickerViewsDays = ({ theme: customTheme = {} }) => {
  ...
  const weekDays = getWeekDays(language2, weekStart);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: theme2.items.base, children: [...Array(42)].map((_date, index2) => {
      ...
      const day = getFormattedDate(language2, currentDate, { day: "numeric" });
...
const DatepickerViewsMonth = ({ theme: customTheme = {} }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: theme2.items.base, children: [...Array(12)].map((_month, index2) => {
    ...
    const month = getFormattedDate(language2, newDate, { month: "short" });
...
const DatepickerRender = ({
  ...
  const [viewDate, setViewDate] = reactExports.useState(defaultDate);
  ...
  const getViewTitle = () => {
    switch (view) {
      ...
      case Views.Months:
        return getFormattedDate(language2, viewDate, { year: "numeric" });
      case Views.Days:
      default:
        return getFormattedDate(language2, viewDate, { month: "long", year: "numeric" });
    }
  };
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: twMerge(theme2.root.base, className), children: [
        !inline && /* @__PURE__ */ jsxRuntimeExports.jsx(
          TextInput,
          {
            ...
            value: selectedDate && getFormattedDate(language2, selectedDate),
            readOnly: true,
            ...props
          }
        ),
...
function useHover(context, props) {
  ...
  reactExports.useEffect(() => {
    ...
    if (isElement(domReference)) {
      ...
      move2 && ref.addEventListener("mousemove", onMouseEnter, {
        once: true
      });
      ...
      return () => {
        ...
        move2 && ref.removeEventListener("mousemove", onMouseEnter);
        ref.removeEventListener("mouseenter", onMouseEnter);
        ref.removeEventListener("mouseleave", onMouseLeave);
      };
    }
  }, [domReference, floating, enabled, context, mouseOnly, restMs, move2, closeWithDelay, cleanupMouseMoveHandler, clearPointerEvents, onOpenChange, open, tree, delayRef, handleCloseRef, dataRef]);
  index(() => {
...
function useInteractions(propsList) {
  ...
  const getReferenceProps = reactExports.useCallback((userProps) => mergeProps(userProps, propsList, "reference"), deps);
  const getFloatingProps = reactExports.useCallback((userProps) => mergeProps(userProps, propsList, "floating"), deps);
...
const Trigger = ({
  ...
  return inline ? /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", ref: refs.setReference, className: theme2?.inlineWrapper, disabled, ...a11yProps, children }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { ...buttonProps, disabled, type: "button", ref: refs.setReference, ...a11yProps, children });
};
...
function ThemeInit({ mode, theme: theme2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeModeInit, { mode }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeServerInit, { theme: theme2 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeClientInit, { theme: theme2 })
  ] });
}
const Flowbite = ({ children, theme: theme2 }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeInit, { mode: theme2?.mode, theme: theme2?.theme }),
    children
  ] });
};
...
const NavbarLink = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Component,
    {
      className: twMerge(
        theme2.base,
        active2 && theme2.active.on,
        !active2 && !disabled && theme2.active.off,
...
const PaginationButton = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      type: "button",
      className: twMerge(active2 && theme2.pages.selector.active, className),
      onClick,
      ...props,
      children
    }
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ListItem, { theme: theme2, className: theme2.listItem, id: id2, isCollapsed, tooltipChildren: children, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Component,
      {
        ...
        children: [
          ...
          isCollapsed && !Icon && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: theme2.collapsed?.noIcon, children: children.charAt(0).toLocaleUpperCase() ?? "?" }),
...
const TimelineContent = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(TimelineContentContext.Provider, { value: { theme: theme2 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-testid": "timeline-content", className: twMerge(horizontal && theme2.root.base, className), ...props, children }) });
};
...
function alwaysNewT(i18n, language2, namespace, keyPrefix) {
  return i18n.getFixedT(language2, namespace, keyPrefix);
}
function useMemoizedT(i18n, language2, namespace, keyPrefix) {
  return reactExports.useCallback(alwaysNewT(i18n, language2, namespace, keyPrefix), [i18n, language2, namespace, keyPrefix]);
}
...
const SettingsProvider = ({ children }) => {
  ...
  reactExports.useEffect(() => {
    if (i18n.language === settings2.language) {
      console.log(i18n.language, settings2.language);
      const direction2 = settings2.language === "ar" ? "rtl" : "ltr";
      document.body.dir = direction2;
      document.documentElement.lang = settings2.language;
      return;
    }
    i18n.changeLanguage(settings2.language);
    const direction = settings2.language === "ar" ? "rtl" : "ltr";
    document.body.dir = direction;
    document.documentElement.lang = settings2.language;
  }, [settings2.language]);
  reactExports.useEffect(() => {
    ipc.invoke("getSetting").then((response) => {
      ...
      if (response.mode === "system") {
        ...
        console.log("response.mode", settings2);
        setSettings((pre) => {
          return {
            ...pre,
            theme: response.mode,
    ...
    console.log("SettingsProvider initialized", /* @__PURE__ */ new Date());
  }, []);
  reactExports.useEffect(() => {
    const cetTitle = document.getElementsByClassName("cet-title");
    console.log(cetTitle);
    if (cetTitle.length > 0) {
      cetTitle[0].textContent = settings2.appName;
    }
  }, [settings2.appName]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsContext.Provider, { value: { settings: settings2, updateSettings }, children });
};
const SidebarTheme = {
  root: {
...
const exams$1 = "Exams";
const committees$1 = "Committees";
const students$1 = "Students";
const settings$1 = "Settings";
const language$1 = "Language";
const active$1 = "Active";
const deactivate$1 = "Deactivate";
const activate$1 = "Activate";
const arabic$1 = "Arabic";
const sheet$1 = "Sheet";
const question$1 = "Question";
const browse$1 = "Browse";
const edit$1 = "Edit";
const move$1 = "Move";
const school$1 = "School";
const section$1 = "Section";
const grade$1 = "Grade Level";
const cancel = "Cancel";
const save$1 = "Save";
...
const en = {
  ...
  settings: settings$1,
  "dark-mode": "Dark Mode",
  "enable-dark-mode": "Enable Dark Mode to reduce eye strain",
  "display-settings": "Display Settings",
  language: language$1,
  "change-language": "Change the language of the application",
  "license-information": "License Information",
  active: active$1,
  deactivate: deactivate$1,
  activate: activate$1,
  "license-is-active": "License is activated to this device and will expire on {{date}}",
  arabic: arabic$1,
  "school-settings": "School Settings",
  "update-school-information": "Update your school information",
  "school-name": "School Name",
  "school-name-placeholder": "Enter your school name",
  "school-address": "School Address",
  "school-address-placeholder": "Enter your school address",
  ...
  sheet: sheet$1,
  question: question$1,
  "add-more-students": "Add More",
  "import-from-excel-file": "Import from Excel file",
  "import": "Import",
  "import-students": "Import Students",
  "select-a-excel-file-to-import-students": "Select a Excel file to import students",
  browse: browse$1,
  edit: edit$1,
  "delete": "Delete",
  move: move$1,
  ...
  "1-select-the-sheet-name": "1. Select the sheet name",
  "select-a-sheet-name": "Select a sheet name",
  "2-enter-header-line-number": "2. Enter Header Line Number",
  "3-enter-school-column": "3. Enter School Column",
  "4-enter-grade-column": "4. Enter Grade Column",
  "5-enter-section-column": "5. Enter Section Column",
  "6-select-the-student-name-column": "6. Select the Student Name Column",
  "7-select-the-student-id-column": "7. Select the Student ID Column",
  "8-enter-the-starting-row-number-and-ending-row-number": "8. Enter the starting row number and ending row number",
  cancel,
  "imported-students-successfully": "Imported students successfully",
  "import-canceled": "Import canceled",
  "records-found": "Records found",
  "no-records-found": "No records found",
  "create-more-students": "Create more students",
  save: save$1,
  select: select$1,
  "order-by": "Order by",
  ...
  "delete-student-message": "Are you sure you want to delete this student?",
  next: next$1,
  previous: previous$1,
...
const active = "نشط";
const deactivate = "إلغاء التنشيط";
const activate = "تنشيط";
const arabic = "عربي";
const sheet = "الورقة";
...
const ar = {
  ...
  "enable-dark-mode": "قم بتمكين الوضع الداكن لتقليل إجهاد العين",
  "display-settings": "إعدادات العرض",
  language,
  "change-language": "تغيير لغة التطبيق",
  "license-information": "معلومات الترخيص",
  active,
  deactivate,
  activate,
  "license-is-active": "تم تنشيط الترخيص على هذا الجهاز وستنتهي صلاحيته في {{date}}",
  arabic,
  "school-settings": "إعدادات المدرسة",
  "update-school-information": "تحديث معلومات المدرسة",
  "school-name": "اسم المدرسة",
  "school-name-placeholder": "أدخل اسم المدرسة",
  "school-address": "عنوان المدرسة",
  "school-address-placeholder": "أدخل عنوان المدرسة",
  "students-list": "قائمة الطلاب",
  "10th-grade": "الأول الثانوي",
  "11th-grade": "الثاني الثانوي",
  "12th-grade": "الثالث الثانوي",
  sheet,
  question,
  "import-from-excel-file": "استيراد من ملف Excel",
  "import": "استيراد",
  "import-students": "استيراد الطلاب",
  "select-a-excel-file-to-import-students": "حدد ملف Excel لاستيراد الطلاب",
  browse,
  "add-more-students": "أضف المزيد",
  edit,
  "delete": "حذف",
  move,
  ...
  "create-committee": "إنشاء لجنة",
  "assign-students": "تعيين الطلاب",
  "export": "تصدير",
  "im-using-template": "أنا أستخدم ملف القالب لاستيراد الطلاب",
  "importing-students-from-excel-file-is-easy-just-follow-the-steps-below": "يعد استيراد الطلاب من ملف Excel أمرًا سهلاً. كل ما عليك القيام به هو إتباع الخطوات أدناه",
  "1-select-the-sheet-name": "1. حدد اسم الورقة",
  "select-a-sheet-name": "حدد اسم الورقة",
  "2-enter-header-line-number": "2. أدخل رقم سطر الرأس",
  "3-enter-school-column": "3. أدخل عمود المدرسة",
  "4-enter-grade-column": "4. أدخل عمود الصف",
  "5-enter-section-column": "5. أدخل عمود القسم",
  "6-select-the-student-name-column": "6. حدد عمود اسم الطالب",
  "7-select-the-student-id-column": "7. حدد عمود رقم الطالب",
  "8-enter-the-starting-row-number-and-ending-row-number": "8. أدخل رقم الصف البدئي ورقم الصف النهائي",
  "imported-students-successfully": "تم استيراد الطلاب بنجاح",
  "import-canceled": "تم إلغاء الاستيراد",
  "records-found": "السجلات الموجودة",
  "no-records-found": "لا توجد سجلات",
  "create-more-students": "إنشاء المزيد من الطلاب",
  save,
  select,
  "order-by": "ترتيب حسب",
  ...
  "delete-student-message": "هل أنت متأكد أنك تريد حذف هذا الطالب؟",
  next,
  previous,
...
const LogoImage = "" + new URL("favicon-B71iGzv3.svg", import.meta.url).href;
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar.Items, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Sidebar.ItemGroup, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Sidebar.Item,
            {
              ...
              children: FM("committee")
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar.Item, { href: "#students", active: path === "/students", icon: FaUserGraduate, children: FM("students") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Sidebar.Item,
            {
              href: "#settings",
...
const Exams = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Exams" });
};
...
const Settings = ({ onDeactivate }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold mb-2", children: FM("display-settings") }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dark:bg-gray-800 bg-gray-100 flex items-center mb-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base p-4 flex justify-center w-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MdOutlineSettings, { fontSize: 28 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-base flex-1 py-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: FM("dark-mode") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", children: FM("enable-dark-mode") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base p-4 flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "inline-flex items-center cursor-default", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "checkbox",
            value: "",
            checked: settings2.theme === "dark",
            onChange: (e) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-cyan-300 dark:peer-focus:ring-cyan-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-cyan-600" })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dark:bg-gray-800 bg-gray-100 flex items-center mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base p-4 flex justify-center w-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx(HiMiniLanguage, { fontSize: 28 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-base flex-1 py-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: FM("language") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", children: FM("change-language") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base p-4 flex items-center w-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Select,
        {
          className: "w-full",
          sizing: "sm",
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "ar", children: FM("arabic") })
          ]
        }
      ) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold mb-2", children: FM("license-information") }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dark:bg-gray-800 bg-gray-100 flex items-center mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base p-4 flex justify-center w-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx(VscVmActive, { fontSize: 28 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-base flex-1 py-4", children: [
...
const StudentsProvider = ({ children }) => {
  ...
  const [studentGroups, setStudentGroups] = reactExports.useState();
  const [page, setPage] = reactExports.useState(1);
  const [perPage, setPerPage] = reactExports.useState(50);
  const [className, setClassName] = reactExports.useState();
  const [searchBy, setSearchBy] = reactExports.useState();
  const [order, orderBy] = reactExports.useState();
  const getStudentList = () => {
    ipc.invoke("getStudents", { page, perPage, class: className, orderBy: order, searchBy }).then((data) => {
      setStudents(data);
    });
  };
  const getStudentGroups = () => {
    ipc.invoke("getStudentGroups").then((data) => {
...
const PromptDialog = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Modal, { theme: ModalTheme, show, onClose, size: "sm", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Modal.Footer, { className: "justify-end py-3 px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "rtl:ml-2", onClick: handleSave, children: okText }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "rtl:ml-2", color: "gray", onClick: onClose, children: cancelText })
    ] })
  ] });
};
...
const SectionAccordion = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "accordionFlushExample", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-none border border-e-0 border-s-0 border-t-0 border-neutral-200 dark:border-neutral-600 dark:bg-body-dark", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-0 flex", id: "flush-headingOne", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
...
const Students = () => {
  ...
  const [studentData, setStudentData] = reactExports.useState({
    studentName: "",
    studentID: "",
    studentSchoolName: "",
    studentClass: "",
  ...
  const renderSelectOptions = (field) => {
    ...
    switch (field) {
      case "studentSchoolName":
        return schoolOptions.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: option, children: option }, option));
      case "studentClass":
        return gradeOptions.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: option, children: option }, option));
      case "studentSection":
        return sectionOptions.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: option, children: option }, option));
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "" });
    }
  };
  ...
  const deleteStudent = () => {
    if (deleteId) {
      ipc.invoke("deleteStudent", deleteId).then((data) => {
        console.log("data", data);
        reloadData();
  ...
  const renderSearchModal = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Modal,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Modal.Header, { className: "py-3", children: FM("search") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Modal.Body, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-5 ", children: fields?.map((field) => {
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Modal.Footer, { className: "justify-end py-3 px-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "rtl:ml-2", onClick: handleSearch, children: FM("search") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                color: "gray",
  ...
  const renderSearchedBy = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-0 flex flex-1", children: [
      "Searched By: ",
      re2
    ] });
  };
  const renderDeleteModal = () => {
    const student = students2?.students.find((student2) => student2.id === deleteId);
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Modal,
      {
        popup: true,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Modal.Footer, { className: "justify-center py-3 px-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { color: "gray", onClick: () => setOpenDeleteModal(false), children: FM("cancel") })
          ] })
        ]
      }
    );
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center grow", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            onClick: saveStudent,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2 flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: SaveIcon }) }),
